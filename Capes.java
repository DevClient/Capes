public class Capes implements LayerRenderer<AbstractClientPlayer> {
	
	public static boolean capeEnabled = true;
	private static final GameProfile GameProfile = null;
	private final RenderPlayer playerRenderer;

	String ClientOwner = "iMPDevMC";           // d18cfba16c754b66bf2e6fbc5c72306f | ClientOwner
	
	public Capes(RenderPlayer playerRendererIn) {
	...
	public void doRenderLayer(AbstractClientPlayer entitylivingbaseIn, float p_177141_2_, float p_177141_3_,
		...
		if (entitylivingbaseIn.getName().equals(ClientOwner) && !entitylivingbaseIn.isInvisible()) {
			...
			ResourceLocation ACape;
			Cape = new ResourceLocation("impdevmc/cosmetics/capes/ClientOwner.png");
			ACape = new ResourceLocation("impdevmc/cosmetics/animated_capes/iMPDevMC.gif");
